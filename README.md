# 🚗 Reducing friction between users and predicting rental prices based on car specs
...
---
Most of the EDA is in the Project-8-Get_around-EDA notebook, accessible through the repo, and I have included the most relevant infos in the dashboard.
